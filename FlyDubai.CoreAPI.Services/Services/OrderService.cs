...
namespace FlyDubai.CoreAPI.Services.Services
{
    ...
    {
        public async Task<OrderResponse> AddToCartAsync(OrderRequest request, string endpointBaseUrl, string accessToken)
        {
            try
            {
                ...
                var endpointUrl = endpointBaseUrl + "/order/cart";
